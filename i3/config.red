...
bindsym $mod+d exec dmenu_run -fn 'xos4 Terminus:size=8' -nb '#000000' -nf "$dmenu_color" -sf '#000000' -sb "$dmenu_color"
...
exec --no-startup-id feh --bg-center ~/Wallpapers/tokyoTower.jpg
...
#Shutdown
bindsym $mod+shift+e exec --no-startup-id dmenu_exit
...
#NowPlaying Script
#exec --no-startup-id ~/bin/NowPlayingHost &
